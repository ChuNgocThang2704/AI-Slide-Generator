    ...
    public PaymentResponse createPaymentLink(PaymentRequest request) {
        ...
        try {
            PaymentLinkItem item = PaymentLinkItem.builder()
                    .name(request.getDescription() != null ? request.getDescription() : "Thanh toan LecGen")
                    .quantity(1)
                    .price(amount)
                    .build();
            ...
            CreatePaymentLinkRequest paymentData = CreatePaymentLinkRequest.builder()
                    ...
                    .amount(amount)
                    .description(request.getDescription() != null ? request.getDescription() : "Thanh toan LecGen")
