...
public enum ErrorCode {
    ...
    INVALID_FILE_FORMAT(400, "Invalid file format. Only .pptx or .potx is allowed", HttpStatus.BAD_REQUEST),
    INVALID_TEMPLATE_FILE(400, "PowerPoint template is invalid or unsupported", HttpStatus.BAD_REQUEST),
    ;
